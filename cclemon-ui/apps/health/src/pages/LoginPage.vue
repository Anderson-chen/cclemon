    ...
    <div class="login-container">
      ...
      <div class="login-brand-panel">
        <div class="brand-inner">
          <div class="brand-icon-wrap">
            <q-icon name="monitor_weight" size="48px" color="white" />
          </div>
          <h1 class="brand-title">cclemon Health</h1>
          <p class="brand-subtitle">健康管理系統</p>
      ...
      <div class="login-form-panel">
        ...
        <div class="mobile-logo">
          <q-icon name="monitor_weight" size="32px" color="teal-8" />
          <span class="mobile-logo-text">cclemon Health</span>
        </div>
