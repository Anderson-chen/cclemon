    ...
    <q-header class="app-header">
      <q-toolbar class="app-toolbar">
        ...
        <q-toolbar-title class="app-brand">
          <q-icon name="monitor_weight" size="22px" color="white" />
          <span class="app-brand-name">cclemon Health</span>
        </q-toolbar-title>
      </q-toolbar>
    </q-header>
    ...
    <q-drawer v-model="leftDrawerOpen" show-if-above bordered class="app-drawer">
      ...
      <div class="drawer-brand">
        <div class="drawer-brand-icon">
          <q-icon name="monitor_weight" size="24px" color="white" />
        </div>
        <div>
          <div class="drawer-brand-title">cclemon Health</div>
          <div class="drawer-brand-sub">健康管理系統</div>
        </div>
      </div>
