...
const VUE_APP_CLIENT_ID = process.env.VUE_APP_CLIENT_ID ?? '';
const VUE_APP_REDIRECT_URI = process.env.VUE_APP_REDIRECT_URI ?? '';
const VUE_APP_SCOPE = process.env.VUE_APP_SCOPE ?? '';
const VUE_APP_POST_LOGOUT_REDIRECT_URI = process.env.VUE_APP_POST_LOGOUT_REDIRECT_URI ?? '';
