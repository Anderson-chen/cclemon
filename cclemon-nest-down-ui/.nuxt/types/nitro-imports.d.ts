declare global {
  ...
  const buildAuthorizationUrl: typeof import('../../server/utils/oidc').buildAuthorizationUrl
  const buildLogoutUrl: typeof import('../../server/utils/oidc').buildLogoutUrl
  ...
  const exchangeCode: typeof import('../../server/utils/oidc').exchangeCode
  const fetchOidcConfig: typeof import('../../server/utils/oidc').fetchOidcConfig
  const fetchUserInfo: typeof import('../../server/utils/oidc').fetchUserInfo
  const fetchWithEvent: typeof import('../../node_modules/h3').fetchWithEvent
  const fromNodeMiddleware: typeof import('../../node_modules/h3').fromNodeMiddleware
  const fromPlainHandler: typeof import('../../node_modules/h3').fromPlainHandler
  const fromWebHandler: typeof import('../../node_modules/h3').fromWebHandler
  const generatePkce: typeof import('../../server/utils/oidc').generatePkce
  ...
  const refreshAccessToken: typeof import('../../server/utils/oidc').refreshAccessToken
  const removeResponseHeader: typeof import('../../node_modules/h3').removeResponseHeader
  const revokeToken: typeof import('../../server/utils/oidc').revokeToken
...
declare global {
  ...
  // @ts-ignore
  export type { OidcConfig, TokenResponse, UserinfoResponse, AuthorizationOpts, ExchangeCodeOpts, RefreshOpts, LogoutOpts } from '../../server/utils/oidc'
  import('../../server/utils/oidc')
  // @ts-ignore
  export type { SessionData } from '../../server/utils/session'
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'C:/project/nest-down-ui/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'C:/project/nest-down-ui/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { generatePkce, fetchOidcConfig, buildAuthorizationUrl, exchangeCode, refreshAccessToken, revokeToken, fetchUserInfo, buildLogoutUrl } from 'C:/project/nest-down-ui/server/utils/oidc';
export { getAppSession } from 'C:/project/nest-down-ui/server/utils/session';